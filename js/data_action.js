data_action = [
    ...
    },
    {
        ...
        bullets: [
            "คุณไม่สามารถร่ายเวทด้วยการกระทำ และเวทอื่นที่แตกต่างกันด้วยการกระทำพิเศษของคุณในเทิร์นเดียวกัน ยกเว้นว่าการกระทำถูกใช้เพื่อร่ายคาถาแคนทริป",
            ...
            "เวทที่มีส่วนประกอบเป็นวัตถุดิบ เมื่อใช้แล้ววัตถุดิบนั้นจะไม่หายไปเว้นแต่จะระบุไว้อย่างชัดเจน หากไม่มีการระบุค่าของวัตถุ คุณสามารถสันนิษฐานได้ว่าค่าการใช้นั้นน้อยนิดและสามารถหาได้จากกระเป๋าวัตถุดิบ",
            "เวทบางอย่างต้องการให้คุณรักษาสมาธิเพื่อให้เวทยังคงมีผลอยู่ หากคุณเสียสมาธิ เวทดังกล่าวจะสิ้นสุดลง คุณจะเสียสมาธิในการร่ายเวทหากคุณร่ายเวทอื่นอีกครั้งที่ต้องใช้สมาธิ หรือเมื่อคุณถูกทำให้หมดสติ ทุกครั้งที่คุณได้รับความเสียหาย คุณต้องทำการทดสอบ  Constitute เพื่อรักษาสมาธิของคุณ DC จะต้องเท่ากับ 10 หรือครึ่งนึงของความเสียหายที่คุณจะได้รับ แล้วแต่ว่าจำนวนใดจะสูงกว่า"
        ]
    },
    {
        title: "วิ่ง",
    ...
    },
    {
        ...
        reference: "PHB, หน้า 195.",
        bullets: [
            "เพื่อหนีจากการจับ คุณต้องทำสำเร็จในการทดสอบ Strength (Athletics) หรือ Dexterity (Acrobatics) และทดสอบแข่งกับ Strength (Athletics) ของผู้จับ",
            "การหนีจากเงื่อนไขอื่นๆ ที่ตรึงคุณอยู่ (เช่น กุญแจมือ) อาจต้องใช้การทดสอบ Dexterity หรือ Strength ตามที่ระบุโดยเงื่อนไขนั้น"
        ]
    },
    {
        title: "ช่วยเหลือ",
    ...
    },
    {
        ...
        bullets: [
            ...
            "เมื่อคุณพยายามซ่อน ให้ทำการทดสอบ Dexterity (Stealth) และจดผลลัพธ์ จนกว่าคุณจะถูกค้นพบหรือต้องหยุดซ่อน การทดสอบนี้จะถูกวัดกับการทดสอบ Wisdom (Perception)  ของสิ่งมีชีวิตใดๆ ที่พยายามค้นหาสัญญาณการปรากฏตัวของคุณ",
            "สิ่งมีชีวิตจะสังเกตเห็นคุณแม้ว่ามันจะไม่ได้ค้นหา ยกเว้นว่าการทดสอบซ่อนตัวของคุณสูงกว่าการรับรู้เชิงพาสซีฟของมัน",
            "นอกการต่อสู้ คุณยังสามารถใช้การทดสอบ Dexterity (Stealth) เพื่อทำเช่น การซ่อนตัวจากศัตรู เดินลัดผ่านยาม หลบหนีโดยไม่ถูกสังเกต หรือย่องเข้าใกล้ใครบางคนโดยไม่ถูกเห็นหรือได้ยิน"
        ]
    },
    {
        title: "ค้นหา",
        ...
        reference: "PHB, หน้า 193.",
        bullets: [
            "ขึ้นอยู่กับลักษณะของการค้นหาของคุณ DM อาจให้คุณทำการทดสอบ Wisdom (Perception) หรือ Intelligence (Investigation)"
        ]
    },
    {
        title: "เตรียมพร้อม",
    ...
    },
    {
        ...
        bullets: [
            "ทำการทดสอบ Wisdom (Medicine) ด้วยค่า DC 10",
            "หากสำเร็จ สิ่งมีชีวิตนั้นจะมีฟิ้นชีวิตและไม่ต้องทำการทอยเซฟความตายอีกต่อไป",
    ...
    },
    {
        title: "อิมโพรไวส์",
        icon: "juggler",
        subtitle: "การกระทำใดๆ ที่ไม่ได้ระบุไว้",
        description: "ทำการกระทำใดๆ ที่คุณจินตนาการได้",
        reference: "PHB, หน้า 193.",
        bullets: [
            "เมื่อคุณอธิบายการกระทำที่ไม่ได้ระบุไว้ในกฎ DM จะบอกคุณว่าการกระทำนั้นเป็นไปได้หรือไม่ และหากจำเป็น จะต้องทอยลูกเต๋าประเภทใด เพื่อกำหนดความสำเร็จหรือความล้มเหลว"
        ]
    }
]
